...
inputs = {
  ...
  idp_logout_chain_test_url = "https://logontest7.gov.bc.ca/clp-cgi/logoff.cgi?retnow=1&returl=https://test.loginproxy.gov.bc.ca/auth/realms/standard/protocol/openid-connect/logout?client_id=fsa-cognito-idir-dev-4088&post_logout_redirect_uri="
