...
resource "random_password" "famdb_mastercreds_random_password" {
  length           = 16
  special          = true
  override_special = "_%@"
}
...
resource "aws_rds_cluster_instance" "famdb_cluster_instance" {
  cluster_identifier = aws_rds_cluster.famdb_cluster.id
  instance_class     = "db.serverless"
  engine             = aws_rds_cluster.famdb_cluster.engine
  engine_version     = aws_rds_cluster.famdb_cluster.engine_version
}
