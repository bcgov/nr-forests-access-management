"""version 2 of the database changes

Revision ID: V2
Revises: V1
Create Date: 2022-07-21 17:16:24.248977
...
def upgrade() -> None:
    ...
    famApp = op.create_table('fam_application',
    ...
    op.drop_constraint(u'fam_user_group_xref_user_id_fkey', 'fam_user_group_xref', type_='foreignkey')
    op.drop_constraint(u'fam_user_role_xref_user_id_fkey', 'fam_user_role_xref', type_='foreignkey')
    op.drop_constraint(u'fam_application_application_client_id_fkey', 'fam_application', type_='foreignkey')
    op.drop_constraint(u'fam_user_role_xref_role_id_fkey', 'fam_user_role_xref', type_='foreignkey')
    op.drop_constraint(u'fam_group_role_xref_role_id_fkey', 'fam_group_role_xref', type_='foreignkey')
    op.drop_constraint(u'fam_group_client_number_id_fkey', 'fam_group', type_='foreignkey')
    op.drop_constraint(u'fam_group_role_xref_group_id_fkey', 'fam_group_role_xref', type_='foreignkey')
    op.drop_constraint(u'fam_application_group_xref_group_id_fkey', 'fam_application_group_xref', type_='foreignkey')
    op.drop_constraint(u'fam_application_group_xref_application_id_fkey', 'fam_application_group_xref', type_='foreignkey')
    ...
    # insert fam / fom records
    #app.models.model.FamApplication
...
def downgrade() -> None:
    ...
    sa.Column('application_id', sa.INTEGER(), server_default=sa.text("nextval('fam_application_application_id_seq'::regclass)"), autoincrement=True, nullable=False),
    sa.Column('application_name', sa.VARCHAR(length=100), autoincrement=False, nullable=False),
    sa.Column('applicationdescription', sa.VARCHAR(length=200), autoincrement=False, nullable=False),
    sa.Column('application_client_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('create_user', sa.VARCHAR(length=30), autoincrement=False, nullable=False),
    sa.Column('create_date', postgresql.TIMESTAMP(precision=6), server_default=sa.text('CURRENT_DATE'), autoincrement=False, nullable=False),
    sa.Column('update_user', sa.VARCHAR(length=30), autoincrement=False, nullable=False),
    sa.Column('update_date', postgresql.TIMESTAMP(precision=6), server_default=sa.text('CURRENT_DATE'), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['application_client_id'], ['fam_application_client.application_client_id'], name='fam_application_application_client_id_fkey'),
    sa.PrimaryKeyConstraint('application_id', name='fam_application_pkey'),
    postgresql_ignore_search_path=False
    )
    op.create_table('fam_group',
    sa.Column('group_id', sa.INTEGER(), server_default=sa.text("nextval('fam_group_group_id_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.Column('client_number_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('create_user', sa.VARCHAR(length=30), autoincrement=False, nullable=False),
    sa.Column('create_date', postgresql.TIMESTAMP(precision=6), server_default=sa.text('CURRENT_DATE'), autoincrement=False, nullable=False),
    sa.Column('update_user', sa.VARCHAR(length=30), autoincrement=False, nullable=False),
    sa.Column('update_date', postgresql.TIMESTAMP(precision=6), server_default=sa.text('CURRENT_DATE'), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['client_number_id'], ['fam_forest_client.client_number_id'], name='fam_group_client_number_id_fkey'),
    sa.ForeignKeyConstraint(['parent_group_id'], ['fam_group.group_id'], name='fam_group_parent_group_id_fkey'),
    sa.PrimaryKeyConstraint('group_id', name='fam_group_pkey'),
    postgresql_ignore_search_path=False
    )
    op.create_table('fam_group_role_xref',
    sa.Column('role_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('group_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['group_id'], ['fam_group.group_id'], name='fam_group_role_xref_group_id_fkey'),
    sa.ForeignKeyConstraint(['role_id'], ['fam_role.role_id'], name='fam_group_role_xref_role_id_fkey'),
    sa.PrimaryKeyConstraint('role_id', 'group_id', name='fam_group_role_xref_pkey')
    )
    op.create_table('fam_user',
    sa.Column('user_id', sa.INTEGER(), server_default=sa.text("nextval('fam_user_user_id_seq'::regclass)"), autoincrement=True, nullable=False),
    sa.Column('user_type', sa.VARCHAR(length=1), autoincrement=False, nullable=False),
    sa.Column('cognito_user_id', sa.VARCHAR(length=32), autoincrement=False, nullable=True),
    sa.Column('user_name', sa.VARCHAR(length=100), autoincrement=False, nullable=False),
    sa.Column('user_guid', sa.VARCHAR(length=32), autoincrement=False, nullable=False),
    sa.Column('create_user', sa.VARCHAR(length=30), autoincrement=False, nullable=False),
    sa.Column('create_date', postgresql.TIMESTAMP(precision=6), server_default=sa.text('CURRENT_DATE'), autoincrement=False, nullable=False),
    sa.Column('update_user', sa.VARCHAR(length=30), autoincrement=False, nullable=False),
    sa.Column('update_date', postgresql.TIMESTAMP(precision=6), server_default=sa.text('CURRENT_DATE'), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('user_id', name='fam_user_pkey'),
    sa.UniqueConstraint('user_guid', name='fam_user_user_guid_key'),
    postgresql_ignore_search_path=False
    )
    op.create_table('fam_forest_client',
    sa.Column('client_number_id', sa.INTEGER(), server_default=sa.text("nextval('fam_forest_client_client_number_id_seq'::regclass)"), autoincrement=True, nullable=False),
    sa.Column('client_name', sa.VARCHAR(length=100), autoincrement=False, nullable=False),
    sa.Column('create_user', sa.VARCHAR(length=30), autoincrement=False, nullable=False),
    sa.Column('create_date', postgresql.TIMESTAMP(precision=6), server_default=sa.text('CURRENT_DATE'), autoincrement=False, nullable=False),
    sa.Column('update_user', sa.VARCHAR(length=30), autoincrement=False, nullable=False),
    sa.Column('update_date', postgresql.TIMESTAMP(precision=6), server_default=sa.text('CURRENT_DATE'), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('client_number_id', name='fam_forest_client_pkey'),
    postgresql_ignore_search_path=False
    )
    op.create_table('fam_role',
    sa.Column('role_id', sa.INTEGER(), server_default=sa.text("nextval('fam_role_role_id_seq'::regclass)"), autoincrement=True, nullable=False),
    sa.Column('role_name', sa.VARCHAR(length=100), autoincrement=False, nullable=False),
    sa.Column('role_purpose', sa.VARCHAR(length=200), autoincrement=False, nullable=False),
    ...
    sa.Column('update_user', sa.VARCHAR(length=30), autoincrement=False, nullable=False),
    sa.Column('update_date', postgresql.TIMESTAMP(precision=6), server_default=sa.text('CURRENT_DATE'), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['application_id'], ['fam_application.application_id'], name='fam_role_application_id_fkey'),
    sa.ForeignKeyConstraint(['client_number_id'], ['fam_forest_client.client_number_id'], name='fam_role_client_number_id_fkey'),
    sa.ForeignKeyConstraint(['parent_role_id'], ['fam_role.role_id'], name='fam_role_parent_role_id_fkey'),
    sa.PrimaryKeyConstraint('role_id', name='fam_role_pkey'),
    postgresql_ignore_search_path=False
    )
    op.create_table('fam_user_role_xref',
    sa.Column('user_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('role_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['role_id'], ['fam_role.role_id'], name='fam_user_role_xref_role_id_fkey'),
    sa.ForeignKeyConstraint(['user_id'], ['fam_user.user_id'], name='fam_user_role_xref_user_id_fkey'),
    sa.PrimaryKeyConstraint('user_id', 'role_id', name='fam_user_role_xref_pkey')
    )
    op.create_table('fam_user_group_xref',
    sa.Column('user_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('group_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['group_id'], ['fam_group.group_id'], name='fam_user_group_xref_group_id_fkey'),
    sa.ForeignKeyConstraint(['user_id'], ['fam_user.user_id'], name='fam_user_group_xref_user_id_fkey'),
    sa.PrimaryKeyConstraint('user_id', 'group_id', name='fam_user_group_xref_pkey')
    )
    op.create_table('fam_application_client',
    sa.Column('application_client_id', sa.INTEGER(), server_default=sa.text("nextval('fam_application_client_application_client_id_seq'::regclass)"), autoincrement=True, nullable=False),
    sa.Column('cognito_client_id', sa.VARCHAR(length=32), autoincrement=False, nullable=False),
    sa.Column('create_user', sa.VARCHAR(length=30), autoincrement=False, nullable=False),
    sa.Column('create_date', postgresql.TIMESTAMP(precision=6), server_default=sa.text('CURRENT_DATE'), autoincrement=False, nullable=False),
    sa.Column('update_user', sa.VARCHAR(length=30), autoincrement=False, nullable=False),
    sa.Column('update_date', postgresql.TIMESTAMP(precision=6), server_default=sa.text('CURRENT_DATE'), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('application_client_id', name='fam_application_client_pkey'),
    postgresql_ignore_search_path=False
    )
    op.create_table('fam_application_group_xref',
    sa.Column('group_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('application_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['application_id'], ['fam_application.application_id'], name='fam_application_group_xref_application_id_fkey'),
    sa.ForeignKeyConstraint(['group_id'], ['fam_group.group_id'], name='fam_application_group_xref_group_id_fkey'),
    sa.PrimaryKeyConstraint('group_id', 'application_id', name='fam_application_group_xref_pkey')
    )
