"""add environment attr to app

Revision ID: V18
Revises: V17
Create Date: 2023-01-13 13:51:13.683888
...
def upgrade() -> None:
    ...
    fam_app_environment_type_table = op.create_table(
        "fam_app_environment_type",
        sa.Column(
        ...
        sa.PrimaryKeyConstraint(
            "app_environment_type_code", name="fam_app_environment_type_pk"
        ),
        schema="app_fam",
    ...
    # New Application 'app_environment_type_code' column.
    op.add_column(
        "fam_application",
        sa.Column(
            "app_environment_type_code",
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(
        "reffam_app_env_type", "fam_application", schema="app_fam", type_="foreignkey"
    )
