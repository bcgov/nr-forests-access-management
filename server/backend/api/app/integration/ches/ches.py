...
class ChesEmailService:
    ...
    def send_user_access_granted_email(
        ...
        """
        Send the 'access granted' email for a user granted an application role.
        """
        context = {
        ...
        subject = f"You have been granted access to {params.application_description}."

        return self._send_merge(
            template_name="grant_access.html",
            subject=subject,
            to=[params.send_to_email],
            context=context,
        )
