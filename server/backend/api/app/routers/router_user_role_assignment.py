...
def enforce_self_grant_guard(db, cognito_username, target_user_name, target_user_type_code):
    requesting_user = crud_user.get_user_by_cognito_user_id(db, cognito_username)
