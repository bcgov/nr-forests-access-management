...
def test_find_or_create(db_pg_session: Session):
    initial_all = db_pg_session.query(FamForestClientModel).all()
    ...
    after_add_all = db_pg_session.query(FamForestClientModel).all()
    ...
    all_forest_clients = db_pg_session.query(FamForestClientModel).all()
