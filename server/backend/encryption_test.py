...
decrypted_key = base64url_decode(b'cEbVYTQY6rPuc9zJKFDhKha8Nk_W90HHfeOqWvvKLnuANDfm_f0A5mL0iEcbS2uKa_oSJR1ZN-7BUEOQuH5a_Q')
...
# decrypted_token = jwe.decrypt(id_token, decrypted_key)

cipher_text = id_token.split(".", 4)[1]

print(f"just the second part: {cipher_text}")
