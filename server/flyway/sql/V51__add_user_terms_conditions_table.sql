...
;
COMMENT ON COLUMN app_fam.fam_user_terms_conditions.version_id IS 'Number to identity the version of the terms and conditions the user accepted.'
;
...
;
CREATE UNIQUE INDEX fam_tc_user_version_uk ON app_fam.fam_user_terms_conditions(user_id, version_id)
;
