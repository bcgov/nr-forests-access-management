...
--
-- Date Created : Tuesday, July 19, 2022 16:23:28
...
;
alter table app_fam.fam_application add constraint fam_app_name_uk unique (application_name)
;
...
;
COMMENT ON COLUMN app_fam.fam_application_client.application_id IS 'Automatically generated key used to identify the uniqueness of an Application registered under FAM'
;
...
;
alter table app_fam.fam_forest_client add constraint fam_for_cli_name_uk unique (client_name)
;
...
;
alter table app_fam.fam_group add constraint fam_grp_name_uk unique (group_name)
;
...
;
alter table app_fam.fam_role add constraint fam_rle_name_uk unique (role_name)
;
...
;
-- user_guid to take the place of user_name below
alter table app_fam.fam_user add constraint fam_usr_uk unique (user_type, user_name)
;
