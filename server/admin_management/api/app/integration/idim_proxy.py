...
class IdimProxyService:
    """
    The class is used for making requests to lookup IDIR/BCeID information from IDIM Proxy API.
    ...
    def lookup_idir(self, search_params: IdimProxySearchParam) -> IdimProxyIdirInfo:
        """
