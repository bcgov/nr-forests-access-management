...
from tests.constants import (ERROR_VOLIATE_UNIQUE_CONSTRAINT,
                             ...
                             TEST_APPLICATION_ID_FAM, TEST_CREATOR,
                             TEST_FAM_ADMIN_USER,
...
def test_get_user_app_admin_grants_as_fam_admin(
    application_admin_repo: ApplicationAdminRepository,
    ...
    # prepare a new FAM admin from the new_user
    ...
    # test get_user_app_admin_grants for FAM admin.
    fam_admin_grants = application_admin_repo.get_user_app_admin_grants(
        new_fam_admin.user_id
    )
