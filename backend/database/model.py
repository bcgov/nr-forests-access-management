...
class FamApplicationClient(Base):
    ...
    application_client_id = Column(Numeric(10, 0), primary_key=True)
...
class FamForestClient(Base):
    ...
    client_number_id = Column(Numeric(10, 0), primary_key=True)
...
class FamUser(Base):
    ...
    user_id = Column(Numeric(10, 0), primary_key=True)
...
class FamApplication(Base):
    ...
    application_id = Column(Numeric(10, 0), primary_key=True)
    application_name = Column(String(100), nullable=False)
    applicationdescription = Column(String(200), nullable=False)
    application_client_id = Column(ForeignKey('fam_application_client.application_client_id'))
    create_user = Column(String(30), nullable=False)
    create_date = Column(TIMESTAMP(precision=6), nullable=False, server_default=text("CURRENT_DATE"))
    update_user = Column(String(30), nullable=False)
    update_date = Column(TIMESTAMP(precision=6), server_default=text("CURRENT_DATE"))
...
class FamGroup(Base):
    ...
    group_id = Column(Numeric(10, 0), primary_key=True)
...
t_fam_application_group_xref = Table(
    ...
    Column('application_id', ForeignKey('fam_application.application_id'), primary_key=True, nullable=False)
)
...
class FamRole(Base):
    ...
    role_id = Column(Numeric(10, 0), primary_key=True)
    role_name = Column(String(100), nullable=False)
    role_purpose = Column(String(200), nullable=False)
    parent_role_id = Column(ForeignKey('fam_role.role_id'))
    application_id = Column(ForeignKey('fam_application.application_id'), nullable=False)
    client_number_id = Column(ForeignKey('fam_forest_client.client_number_id'))
    create_user = Column(String(30), nullable=False)
    create_date = Column(TIMESTAMP(precision=6), nullable=False, server_default=text("CURRENT_DATE"))
    update_user = Column(String(30), nullable=False)
