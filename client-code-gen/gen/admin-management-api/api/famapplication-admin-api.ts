...
export const FAMApplicationAdminApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getApplicationAdminByApplicationId(applicationId: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<FamAppAdminGetResponse>>> {
...
export const FAMApplicationAdminApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getApplicationAdminByApplicationId(applicationId: number, options?: any): AxiosPromise<Array<FamAppAdminGetResponse>> {
...
export interface FAMApplicationAdminApiInterface {
     ...
     * @memberof FAMApplicationAdminApiInterface
     */
    getApplicationAdminByApplicationId(applicationId: number, options?: AxiosRequestConfig): AxiosPromise<Array<FamAppAdminGetResponse>>;
