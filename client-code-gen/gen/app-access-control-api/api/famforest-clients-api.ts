...
export const FAMForestClientsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        search: async (applicationId: number, clientNumber: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const FAMForestClientsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async search(applicationId: number, clientNumber: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<FamForestClient>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.search(applicationId, clientNumber, options);
...
export const FAMForestClientsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        search(applicationId: number, clientNumber: string, options?: any): AxiosPromise<Array<FamForestClient>> {
            return localVarFp.search(applicationId, clientNumber, options).then((request) => request(axios, basePath));
        },
    };
};
...
export interface FAMForestClientsApiInterface {
     ...
     */
    search(applicationId: number, clientNumber: string, options?: RawAxiosRequestConfig): AxiosPromise<Array<FamForestClient>>;
...
export class FAMForestClientsApi extends BaseAPI implements FAMForestClientsApiInterface {
     ...
     */
    public search(applicationId: number, clientNumber: string, options?: RawAxiosRequestConfig) {
        return FAMForestClientsApiFp(this.configuration).search(applicationId, clientNumber, options).then((request) => request(this.axios, this.basePath));
    }
}
