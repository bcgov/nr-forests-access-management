...
// @ts-ignore
import { PermissionAuditHistoryResDto } from '../model';
/**
...
export const PermissionAuditApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getPermissionAuditHistoryByUserAndApplication(userId: number, applicationId: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<PermissionAuditHistoryResDto>>> {
...
export const PermissionAuditApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getPermissionAuditHistoryByUserAndApplication(userId: number, applicationId: number, options?: any): AxiosPromise<Array<PermissionAuditHistoryResDto>> {
...
export interface PermissionAuditApiInterface {
     ...
     */
    getPermissionAuditHistoryByUserAndApplication(userId: number, applicationId: number, options?: RawAxiosRequestConfig): AxiosPromise<Array<PermissionAuditHistoryResDto>>;
