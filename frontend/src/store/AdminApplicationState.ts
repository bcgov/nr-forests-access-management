...
export const CURRENT_SELECTED_APPLICATION_KEY = 'CURRENT_SELECTED_ADMIN_APPLICATION';

// The applications the user has access to administer
export const allApplications = ref<FamApplication[]>([]);
...
export const setAllApplications = (newValue: FamApplication[]) => {
    allApplications.value = newValue;
};
