  ...
  input = <<JSON
  {
    "flywayRequest": {
        ...
        "placeholders": {
          ...
          "client_id_dev_isp_oidc_client" : "${aws_cognito_user_pool_client.dev_isp_oidc_client.id}",
          "client_id_test_isp_oidc_client" : "${aws_cognito_user_pool_client.test_isp_oidc_client.id}",
          ...
          "client_id_dev_frep_oidc_client" : "${aws_cognito_user_pool_client.dev_frep_oidc_client.id}",
          "client_id_test_frep_oidc_client" : "${aws_cognito_user_pool_client.test_frep_oidc_client.id}",
